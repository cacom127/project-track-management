...
- [ ] **T1** — Migration: thêm cột `projects.industry`/`projects.outcome_note`,
...
- [ ] **T2** — Backend: schemas — thêm `industry`/`outcome_note` vào
...
- [ ] **T3** — Backend: repository — `create_project`/`update_project`
...
- [ ] **T5** — Frontend: `projectsApi.ts`/`projectTypes.ts`-style file
...
|-------------|----------------|----------|
| Đang làm    | 2026-08-19     | Bắt đầu implement trên branch `feature/change-012-project-extra-fields` |
