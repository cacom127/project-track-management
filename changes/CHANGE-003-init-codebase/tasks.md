...
- [ ] **T3** — Cấu hình + kết nối DB qua `app.core.db`, health-check báo
...
- [ ] **T4** — Docker Compose Postgres cho local
      - Liên quan: ARCH-08
...
|--------------|----------------|--------------------------------|
| Đang làm     | 2026-08-15     | T1, T2 xong; đổi layout: bỏ `src/`, code ngay ở root |
